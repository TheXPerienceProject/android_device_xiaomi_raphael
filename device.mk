...
# Fingerprint
PRODUCT_COPY_FILES += \
    vendor/xperience/config/permissions/vendor.xpe.biometrics.fingerprint.inscreen.xml:system/etc/permissions/vendor.xpe.biometrics.fingerprint.inscreen.xml
